...
class RecordParser
  ...
  def str
    ...
    s = @fields.pop
    # Los textos llegan de la red como binario (ASCII-8BIT). Los reetiquetamos a UTF-8 para
    # evitar "incompatible character encodings" al usar nombres/motes del rival (p. ej. la IA
    # que registra el movimiento usado) — eso crasheaba los combates online.
