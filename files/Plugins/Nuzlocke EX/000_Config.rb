module ChallengeModes
  ...
  ###### TODO: Añadir las reglas nuevas al resumen final de regalas elegidas. ######
    ...
    :CAPTURE_COUNTER => {
      :name  => _INTL("Contador de Capturas"),
      :display_name  => _INTL("Contador de Capturas"),
      :desc  => _INTL("Lleva la cuenta de la 1ª captura de cada zona con un AVISO (no bloqueo): puedes capturar de más para tus capturas extra o Pokémon estáticos, y esas se marcan como \"Extra\". Los legendarios/singulares no cuentan si los debilitas o huyes; paradojas y ultraentes sí."),
      :order => 16,
    },
    # :MONOTYPE_CLAUSE => {
