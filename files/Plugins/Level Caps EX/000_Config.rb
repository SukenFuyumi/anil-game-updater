...
module LevelCapsEX
  ...
  # [Añil] false: el modo debug NO desactiva el level cap (evita subirlo a 100 sin querer
  # al recompilar plugins en debug). El cap sigue funcionando normal en la aventura.
  BYPASS_LEVEL_CAP_ON_DEBUG = false
